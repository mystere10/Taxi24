...
1. Clone the repo using this link [here](https://github.com/mystere10/Taxi24.git)
2. Create a .env file use the .env_TEMPLATE file
3. run npm install
4. run npm start to start the app
5. To run tests use the npm run test
